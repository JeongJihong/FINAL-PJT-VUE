<template>
  <div>
    <b-row class="border rounded">
      <h3 class="font-weight-bold my-4 mx-auto">연립 다세대 검색 결과</h3>
    </b-row>
    <b-row class="border rounded">
      <div v-if="houses.length == 0" class="col-sm-3 mx-auto p-2">
        <div class="card">
...
export default {
  ...
  computed: {
    ...
    pageCount () {
      let listLength = this.$store.state.houses.length;
    ...
    paginatedData () {
      ...
      return this.$store.state.houses.slice(start, end);
    },
  },
